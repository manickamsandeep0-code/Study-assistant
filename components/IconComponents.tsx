...
export const HeartPulseIcon: React.FC<IconProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
    <path d="M21.25 12.75a4.5 4.5 0 0 0-6.44-6.24L12 8.75l-2.81-2.24a4.5 4.5 0 0 0-6.44 6.24L12 21l9.25-8.25Z"/>
    <path d="M2.5 12.5h3l2 3 2-6 2 3h3"/>
  </svg>
);
...
export const BrainCircuitIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><path d="M12 2a4.5 4.5 0 0 0-4.5 4.5v.5a4.5 4.5 0 0 0-4.5 4.5v3a4.5 4.5 0 0 0 4.5 4.5h1.5a4.5 4.5 0 0 0 4.5 4.5v.5a4.5 4.5 0 0 0 4.5-4.5v-3a4.5 4.5 0 0 0-4.5-4.5H12a4.5 4.5 0 0 0-4.5-4.5v-.5a4.5 4.5 0 0 0 4.5-4.5Z"/><path d="M12 11.5v4"/><path d="M12 2v2.5"/><path d="M12 20v2"/><circle cx="16" cy="7.5" r=".5"/><circle cx="15" cy="13.5" r=".5"/><circle cx="18.5" cy="11" r=".5"/><circle cx="8" cy="7.5" r=".5"/><circle cx="9" cy="13.5" r=".5"/><circle cx="5.5" cy="11" r=".5"/></svg>
);
